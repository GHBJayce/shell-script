...
# Created: 2022年 6月29日 星期三 10时43分57秒 CST
#
#/ usage: jayce-public/git:pick  --commits <> 
...
rerun_options_parse() {
    ...
    do
        OPT="$1"
        case "$OPT" in
            --commits) rerun_option_check $# $1; COMMITS=$2 ; shift 2 ;;
            # help option
            -\?|--help)
                rerun_option_usage
                exit 2
    ...
    [[ -z "$COMMITS" ]] && { echo >&2 "missing required option: --commits" ; return 2 ; }
